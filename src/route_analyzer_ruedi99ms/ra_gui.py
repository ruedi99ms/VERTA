...
Or as a Python package:
    from route_analyzer_ruedi99ms.ra_gui import launch_gui
    launch_gui()
"""
...
from route_analyzer_ruedi99ms.ra_data_loader import load_folder, load_folder_with_gaze, Trajectory, ColumnMapping
from route_analyzer_ruedi99ms.ra_decisions import discover_decision_chain, discover_branches, assign_branches
...
from route_analyzer_ruedi99ms.ra_plotting import plot_flow_graph_map, plot_per_junction_flow_graph, plot_chain_overview
from route_analyzer_ruedi99ms.ra_metrics import _timing_for_traj, time_between_regions, compute_basic_trajectory_metrics, speed_through_junction, junction_transit_speed
...
from route_analyzer_ruedi99ms.ra_intent_recognition import analyze_intent_recognition, IntentRecognitionAnalyzer
...
class RouteAnalyzerGUI:
    """Main GUI class for Route Analyzer"""
    ...
    def render_header(self):
        ...
        st.markdown('<h1 class="main-header">🗺️ Route Analyzer</h1>', unsafe_allow_html=True)
        st.markdown("""
    ...
    def load_uploaded_files(self, uploaded_files, x_col: str, z_col: str, t_col: str, scale: float, motion_threshold: float):
        ...
        try:
            with st.spinner("Loading uploaded files..."):
                ...
                import tempfile
                import os
                from ra_data_loader import Trajectory, TrajectoryLoader, ColumnMapping
    ...
    def render_analysis(self):
        ...
        with col1:
            ...
            if analysis_type == "predict":
                ...
                if active_trajs:
                    from ra_data_loader import has_vr_headset_data
        ...
        try:
            with st.spinner(f"Running {analysis_type} analysis..."):
                ...
                if analysis_type == "discover":
                    ...
                    try:
                        from ra_data_loader import has_gaze_data as _has_gaze, has_physio_data as _has_physio
                    ...
                    try:
                        from ra_data_loader import has_physio_data as _has_physio
                    ...
                    if not has_gaze_data and not has_any_physio and not column_mappings:
                        ...
                        **Current trajectories only have position data (x, z, t).**
                        ...
                        try:
                            ...
                            try:
                                from ra_gaze import plot_pupil_dilation_heatmap
                                import matplotlib.pyplot as plt
                                import os
                    ...
                    from ra_plotting import _track_trajectory_junction_sequence
    ...
    def _check_for_gaze_data(self, trajectories):
        ...
        from ra_data_loader import has_gaze_data, has_physio_data, has_vr_headset_data
    ...
    def _perform_comprehensive_gaze_analysis_all_junctions(self, trajectories, junctions, r_outer_list, decision_mode, path_length, epsilon, linger_delta, out_dir):
        ...
        import pandas as pd
        import numpy as np
        from ra_gaze import compute_head_yaw_at_decisions, analyze_physiological_at_junctions, analyze_pupil_dilation_trajectory
        ...
        try:
            ...
            with st.spinner("Processing physiological data..."):
                ...
                if current_branch_col not in chain_df_call.columns:
                    ...
                    # CRITICAL FIX: Use ra_consistency.normalize_assignments for proper trajectory ID mapping
                    # This will automatically handle branch column naming and trajectory ID mapping
                    st.info(f"🔧 **Using ra_consistency.normalize_assignments for proper trajectory ID mapping...**")
    ...
    def _render_comprehensive_gaze_results(self, gaze_data, junction_key):
        ...
        if has_global_heatmap or has_junction_heatmaps:
            ...
            from ra_gaze import get_consistent_pupil_scaling
            heatmap_data_list = []
    ...
    def _generate_gaze_plots_during_analysis(self, gaze_data, junction_key, out_dir):
        ...
        try:
            from ra_gaze import plot_gaze_directions_at_junctions
        ...
        try:
            from ra_gaze import plot_physiological_by_branch
        ...
        try:
            from ra_gaze import plot_pupil_trajectory_analysis
        ...
        try:
            ...
            if 'head_yaw' in gaze_data and gaze_data['head_yaw'] is not None:
                ...
                if len(head_yaw_df) > 0:
                    ...
                    from ra_gaze import gaze_movement_consistency_report
